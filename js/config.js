...
ENI.Config = {
    ...
    RUOLI: {
        Admin: {
            ...
            moduli: ['dashboard', 'clienti', 'cassa', 'spese', 'crediti', 'lavaggi', 'magazzino', 'personale', 'manutenzioni', 'log'],
            scrivere: ['clienti', 'cassa', 'spese', 'crediti', 'lavaggi', 'magazzino', 'personale', 'manutenzioni']
        },
        Cassiere: {
            label: 'Cassiere',
            moduli: ['dashboard', 'clienti', 'cassa', 'spese', 'crediti', 'lavaggi', 'magazzino'],
            scrivere: ['cassa', 'spese', 'crediti', 'lavaggi', 'magazzino']
        },
        Lavaggi: {
    ...
    BOTTOM_NAV_ITEMS: ['dashboard', 'lavaggi', 'cassa', 'clienti'],
    ...
    // Categorie magazzino
    CATEGORIE_MAGAZZINO: ['Bar', 'Shop', 'Olio', 'Accessori', 'AdBlue', 'Altro'],
