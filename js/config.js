...
ENI.Config = {
    ...
    RUOLI: {
        Admin: {
            ...
            moduli: ['clienti', 'cassa', 'spese', 'crediti', 'lavaggi', 'vendita', 'magazzino', 'buoni', 'coefficiente-monofase', 'marginalita-carburante', 'ordine-carburante', 'tesoreria', 'fatturazione', 'smac', 'personale', 'mie-richieste', 'timbra', 'buste-paga-mie', 'bonus-venduto', 'manutenzioni', 'log', 'impostazioni'],
