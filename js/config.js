...
ENI.Config = {
    ...
    RUOLI: {
        Admin: {
            ...
            moduli: ['dashboard', 'clienti', 'cassa', 'crediti', 'lavaggi', 'magazzino', 'personale', 'manutenzioni', 'log'],
            scrivere: ['clienti', 'cassa', 'crediti', 'lavaggi', 'magazzino', 'personale', 'manutenzioni']
        },
        Cassiere: {
            label: 'Cassiere',
            moduli: ['dashboard', 'clienti', 'cassa', 'crediti', 'lavaggi', 'magazzino'],
            scrivere: ['cassa', 'crediti', 'lavaggi', 'magazzino']
        },
        Lavaggi: {
