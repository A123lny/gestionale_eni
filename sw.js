...
const CACHE_NAME = 'titanwash-v142';
...
const STATIC_ASSETS = [
    ...
    BASE + 'js/lib/previsione-carburante.js',
    BASE + 'js/router.js',
    BASE + 'js/app.js',
