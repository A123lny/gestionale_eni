...
ALTER TABLE clienti
    ...
    ADD COLUMN IF NOT EXISTS codice_fiscale          VARCHAR(20),
    ...
    ADD COLUMN IF NOT EXISTS modalita_pagamento_fattura VARCHAR(20)
        CHECK (modalita_pagamento_fattura IN ('RIBA','RID_SDD','BONIFICO','CONTANTI','RIMESSA_DIRETTA')),
...
CREATE TABLE IF NOT EXISTS fatture (
    ...
    monofase_mese           INT,
    monofase_anno           INT,
    modalita_pagamento      VARCHAR(20) CHECK (modalita_pagamento IN ('RIBA','RID_SDD','BONIFICO','CONTANTI','RIMESSA_DIRETTA')),
